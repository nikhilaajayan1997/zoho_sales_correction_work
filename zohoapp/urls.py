...
urlpatterns = [
    ...
    path('create_estimate_customer/',views.create_estimate_customer,name='create_estimate_customer'),
    path('get_estimate_customerdet',views.get_estimate_customerdet,name='get_estimate_customerdet'),
